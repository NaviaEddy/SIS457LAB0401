...
ANaveAereaJugador::ANaveAereaJugador()
{
	...
	if (World != nullptr)
	{
		...
		PilaProyectiles.Insertar(World->SpawnActor<AProyectil>(SpawnLocation, FireRotation));
...
void ANaveAereaJugador::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	InputComponent->BindAction(TEXT("Misil"), IE_Pressed, this, &ANaveAereaJugador::Fire);
	InputComponent->BindAction(TEXT("Bomba"), IE_Pressed, this, &ANaveAereaJugador::Fire);
	InputComponent->BindAction(TEXT("Bala"), IE_Pressed, this, &ANaveAereaJugador::Fire);
	InputComponent->BindAction(TEXT("Rayo"), IE_Pressed, this, &ANaveAereaJugador::Fire);
